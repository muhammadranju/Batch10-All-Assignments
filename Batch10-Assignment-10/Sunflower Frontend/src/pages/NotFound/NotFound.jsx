...
const NotFound = () => {
  return (
    <>
      ...
      <Helmet>
        <title>404 Page Not Found | Visa Navigator</title>
      </Helmet>
      <div className="h-screen w-screen flex items-center">
        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
          <div className="max-w-md">
            ...
            <Link to={"/"}>
              <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-indigo bg-indigo-600 active:bg-indigo-600 hover:bg-indigo-700">
                back to homepage
              </button>
            </Link>
          </div>
